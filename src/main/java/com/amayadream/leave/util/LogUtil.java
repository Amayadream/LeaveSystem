...
public class LogUtil {
    ...
    public String LOG_DETAIL_MODEL        = "模型";
    public String LOG_DETAIL_MODEL_FILE   = "模型文件";
    public String LOG_DETAIL_TASK         = "任务";
    public String LOG_DETAIL_OUTSIDE_FILE = "外部文件";
    public String LOG_DETAIL_LEAVE = "请假流程";
